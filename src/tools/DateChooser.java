...
/**
 * Uma caixa de dialogo que tem por objetivo entrada de datas
 * A classe <code>DateChooser</code> apresenta um calendar e permite
 * o usuário selecionar visualmente dia, mês e ano. Não permitindo selecionar
 * uma data inválida.
 **/
public class DateChooser extends JDialog implements ItemListener, MouseListener, FocusListener, KeyListener, ActionListener
{
 ...
 private static final String[] DAYS = new String[] {"Dom","Seg","Ter","Qua","Qui","Sex","Sáb"};
 
 /** posição X e Y na tela do dialog, por padrão é na posição zero */
 private int posX = 0;
 private int posY = 0;
 
 /** cor dos dias da semana no cabeçalho */
 ...
 /** Empty border, usado quando o calendário não possui o foco */
 private static final Border EMPTY_BORDER = BorderFactory.createEmptyBorder(1,1,1,1);
 
 /** Border usado quando calendário tem foco */
 private static final Border FOCUSED_BORDER = BorderFactory.createLineBorder(Color.yellow,1);
 
 /** primeiro ano permitido no calendário */
 private static final int FIRST_YEAR = 1920;
 
 /** último ano permitido */
 private static final int LAST_YEAR = 2020;
 
 /** Variável usada para calcular as datas */
 ...
 public DateChooser( Frame owner, String title, int posX, int posY )
 {
         super( owner, title, true );
         this.posX = posX;
         this.posY = posY;
