...
//        painelBotoes.add(btnRem);
        ...
        btnAdd.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                marca.setIdTipo(daoTipo.autoIdTipo());
                marca.setNomeTipo("Nome");

                try {
                    Tipo c = daoTipo.obter(marca.getIdTipo());
                    if (c == null) {
                        daoTipo.inserir(marca);
                        tableModel.onAdd(marca);
                        tableModel.fireTableDataChanged();
                    } else {
                        JOptionPane.showMessageDialog(cp, "Já existe");
                    }
                } catch (Exception err) {
                    JOptionPane.showMessageDialog(cp, "Erro ao inserir =>" + marca.getIdTipo()
